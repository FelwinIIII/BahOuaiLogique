...
import fr.WalexFelwin.OktaliaHub.Inventaire.Accessoires.InteractAccessoires;
...
import fr.WalexFelwin.OktaliaHub.Update.UpdateScoreBoard;
...
public class Main extends JavaPlugin implements Listener{
	...
	public void onEnable() {
	    ...
	    API_HubPlayer.vipplus.put("vip+", 0);
	    API_HubPlayer.vip.put("vip", 0);
	    API_HubPlayer.monarque.put("monarque", 0);
	    API_HubPlayer.maitre.put("maitre", 0);
	    API_HubPlayer.legionnaire.put("legionnaire", 0);
	    API_HubPlayer.voyageur.put("voyageur", 0);
	...
	public void onDisable() {
	  ...
	  public void registerEvents(){
		    ...
		    pm.registerEvents(new InteractAccessoires(this), this);
