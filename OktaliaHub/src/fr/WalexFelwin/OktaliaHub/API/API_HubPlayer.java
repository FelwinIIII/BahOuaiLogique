...
public class API_HubPlayer {
	  ...
	  public static HashMap<String, Integer> vipplus = new HashMap();
	  public static HashMap<String, Integer> vip = new HashMap();
	  public static HashMap<String, Integer> monarque = new HashMap();
	  public static HashMap<String, Integer> maitre = new HashMap();
	  public static HashMap<String, Integer> legionnaire = new HashMap();
	  public static HashMap<String, Integer> voyageur = new HashMap();
	...
	public static void playergradesadd(Player p){
		...
		if(HASHMAP.Grades.get(p).equalsIgnoreCase("developpeur")){
			   ...
			   if(vipplus.containsKey("vip")){
				   vipplus.put("vip+", 1+vipplus.get("vip+"));
				   
			   } else {
				   vipplus.put("vip+", 1);
			   }
		   } else if(HASHMAP.Grades.get(p).equalsIgnoreCase("monarque")){
			   if(monarque.containsKey("monarque")){
				   monarque.put("monarque", 1+monarque.get("monarque"));
				   
			   } else {
				   monarque.put("monarque", 1);
			   }
		   } else if(HASHMAP.Grades.get(p).equalsIgnoreCase("maitre")){
			   if(maitre.containsKey("maitre")){
				   maitre.put("maitre", 1+maitre.get("maitre"));
				   
			   } else {
				   maitre.put("maitre", 1);
			   }
		   } else if(HASHMAP.Grades.get(p).equalsIgnoreCase("legionnaire")){
			   if(legionnaire.containsKey("legionnaire")){
				   legionnaire.put("legionnaire", 1+legionnaire.get("legionnaire"));
				   
			   } else {
				   legionnaire.put("legionnaire", 1);
			   }
		   } else if(HASHMAP.Grades.get(p).equalsIgnoreCase("voyageur")){
			   if(voyageur.containsKey("voyageur")){
				   voyageur.put("voyageur", 1+voyageur.get("voyageur"));
				   
			   } else {
				   voyageur.put("voyageur", 1);
			   }
		   } else{
	...
	public static void playergradesremove(Player p){
			...
			if(HASHMAP.Grades.get(p).equalsIgnoreCase("developpeur")){
			   ...
			   vipplus.put("vip+", vipplus.get("vip+")-1);
			   
		   } else if(HASHMAP.Grades.get(p).equalsIgnoreCase("monarque")){

			   monarque.put("monarque", monarque.get("monarque")-1);
			   
		   } else if(HASHMAP.Grades.get(p).equalsIgnoreCase("legionnaire")){

			   legionnaire.put("legionnaire", legionnaire.get("legionnaire")-1);
			   
		   } else if(HASHMAP.Grades.get(p).equalsIgnoreCase("maitre")){

			   maitre.put("maitre", maitre.get("maitre")-1);
			   
		   } else if(HASHMAP.Grades.get(p).equalsIgnoreCase("voyageur")){

			   voyageur.put("voyageur", voyageur.get("voyageur")-1);
