...
public class Main extends JavaPlugin implements Listener, PluginMessageListener{
	...
	public void onEnable() {
		...
		Boucle.clock();
		Boucle.clockup();
	    Bukkit.getServer().getMessenger().registerOutgoingPluginChannel(this, "BungeeLogin");
	    Bukkit.getServer().getMessenger().registerIncomingPluginChannel(this, "BungeeLogin", this);
		Mysql.host = "localhost";
		Mysql.port = 3306;
		Mysql.database = "oktalia";
		Mysql.username = "root";
		Mysql.password = "gx7AK27D}e}59p;Cf[";	    
