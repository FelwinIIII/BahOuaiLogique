...
public class ConfigEntries implements ConfigEntryHolder {
    ...
    public static final ConfigEntry<String> ALREADY_IN_LOBBY = new ConfigEntry<>(0, "messages.already", "&cVous êtes dêja connectée sur un Hub !");
    public static final ConfigEntry<String> NO_SERVER_FOUND = new ConfigEntry<>(0, "messages.unsuccessful", "§cHub Introuvable !");
    public static final ConfigEntry<String> CONNECTING_MESSAGE = new ConfigEntry<>(0, "messages.connected", "§aTéléportation à un hub !");
}
