...
import fr.walexmine.OktaliaAuth.listeners.LoginMessage;
  ...
  extends Plugin
{
  ...
  public void onEnable()
  {
    ...
    localPluginManager.registerCommand(this, new LoginAuth());
    ...
    getProxy().registerChannel("BungeeLogin");
    BungeeCord.getInstance().getPluginManager().registerListener(this, new LoginMessage());
