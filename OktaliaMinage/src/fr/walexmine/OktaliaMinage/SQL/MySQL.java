...
public class MySQL {
	  ...
	  public static Connection openConnection()
	  {
	    ...
	    try
	    {
	      ...
	      System.out.println(org.bukkit.ChatColor.GREEN+"OktaliaMine est bien connectée a la base de données");
	      return conn;
	    }
	    catch (SQLException e)
	    {
	      System.out.println(org.bukkit.ChatColor.RED+"OktaliaMine n'est pas bien connectée a la base de données");
