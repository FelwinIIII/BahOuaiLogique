package fr.walexmine.OktaliaMinage.Commands;
...
public class Reserve implements CommandExecutor{
	  ...
	  public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args)
	  {
	    ...
	    if (label.equalsIgnoreCase("Reserve"))
	    {
	    	...
	    	fr.walexmine.OktaliaMinage.Inventaire.Reserve.RESERVE(p);
	    		
	    	}
	    	if(p.getWorld().getName().equalsIgnoreCase("minage")) {
	    		
	    	fr.walexmine.OktaliaMinage.Inventaire.Reserve.RESERVEMINAGE(p);
	    	...
	    	if(p.isOp()) {
		    	...
		    	if (args.length == 1) {
    	    	    ...
    	    	    {
    	    	    	p.sendMessage(""+fr.walexmine.OktaliaMinage.Inventaire.Reserve.ReserveMine.get(p));
    	    	    } else {
