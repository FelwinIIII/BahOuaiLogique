...
public class Alchimie
{
  public static void AlchimieALL(Player p)
  {
    Inventory inv = Bukkit.createInventory(null, 54, "§6Alchimie");
    
    API_Inventaire.additemsShop(376, 1, 0, inv, "", null, 11, 1, 2);
    API_Inventaire.additemsShop(377, 1, 0, inv, "", null, 12, 1, 2);
    API_Inventaire.additemsShop(378, 1, 0, inv, "", null, 13, 1, 2);
    API_Inventaire.additemsShop(414, 1, 0, inv, "", null, 14, 1, 2);
    API_Inventaire.additemsShop(382, 1, 0, inv, "", null, 15, 1, 2);
    API_Inventaire.additemsShop(396, 1, 0, inv, "", null, 21, 1, 2);
    API_Inventaire.additemsShop(380, 1, 0, inv, "", null, 22, 1, 2);
    API_Inventaire.additemsShop(370, 1, 0, inv, "", null, 23, 1, 2);
    API_Inventaire.additemsShop(379, 1, 0, inv, "", null, 31, 1, 2);
