...
public class VIP {
	...
	public static void VIPPreview(Player p) {
		Inventory inv = Bukkit.createInventory(null, 54, "§7§lKit §b§lVIP");
		...
		API_Inventaire.additemsenchant(310, 1, 0, inv, Enchantment.PROTECTION_ENVIRONMENTAL, 3, Enchantment.DURABILITY, 3, "", null, 12);
		API_Inventaire.additemsenchant(311, 1, 0, inv, Enchantment.PROTECTION_ENVIRONMENTAL, 3, Enchantment.DURABILITY, 3, "", null, 13);
		API_Inventaire.additemsenchant(312, 1, 0, inv, Enchantment.PROTECTION_ENVIRONMENTAL, 3, Enchantment.DURABILITY, 3, "", null, 14);
		API_Inventaire.additemsenchant(313, 1, 0, inv, Enchantment.PROTECTION_ENVIRONMENTAL, 3, Enchantment.DURABILITY, 3, "", null, 15);
		API_Inventaire.additems(160, 1, 7, inv, "", null, 17);
		API_Inventaire.additems(160, 1, 7, inv, "", null, 18);
		API_Inventaire.additems(322, 12, 0, inv, "", null, 20);
		...
		API_Inventaire.additems(368, 8, 0, inv, "", null, 24);
		API_Inventaire.additems(259, 1, 0, inv, "", null, 30);
		API_Inventaire.additems(46, 4, 0, inv, "", null, 32);
