...
public class Maitre {
	public static void MaitrePreview(Player p) {
		Inventory inv = Bukkit.createInventory(null, 54, "§7§lKit §6§lMaitre");
		...
		API_Inventaire.additemsenchant(276, 1, 0, inv, Enchantment.DAMAGE_ALL, 3, Enchantment.DURABILITY, 2, "", null, 11);
		API_Inventaire.additemsenchant(306, 1, 0, inv, Enchantment.PROTECTION_ENVIRONMENTAL, 2, Enchantment.DURABILITY, 2, "", null, 12);
		API_Inventaire.additemsenchant(311, 1, 0, inv, Enchantment.PROTECTION_ENVIRONMENTAL, 2, Enchantment.DURABILITY, 2, "", null, 13);
		API_Inventaire.additemsenchant(312, 1, 0, inv, Enchantment.PROTECTION_ENVIRONMENTAL, 2, Enchantment.DURABILITY, 2, "", null, 14);
		API_Inventaire.additemsenchant(309, 1, 0, inv, Enchantment.PROTECTION_ENVIRONMENTAL, 2, Enchantment.DURABILITY, 2, "", null, 15);
		API_Inventaire.additems(160, 1, 7, inv, "", null, 17);
		API_Inventaire.additems(160, 1, 7, inv, "", null, 18);
		API_Inventaire.additems(322, 6, 0, inv, "", null, 20);
		API_Inventaire.additemsenchant(257, 1, 0, inv, Enchantment.DIG_SPEED, 5, Enchantment.DURABILITY, 2, "", null, 21);
		API_Inventaire.additemsenchant(258, 1, 0, inv, Enchantment.DIG_SPEED, 5, Enchantment.DURABILITY, 2, "", null, 22);
		API_Inventaire.additemsenchant(256, 1, 0, inv, Enchantment.DIG_SPEED, 5, Enchantment.DURABILITY, 2, "", null, 23);
		API_Inventaire.additems(368, 4, 0, inv, "", null, 24);
